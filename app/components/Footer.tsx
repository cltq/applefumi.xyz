      ...
      >
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          <div className="flex flex-col items-center sm:items-start gap-1">
            <p
              className="text-sm sm:text-base font-[family-name:var(--font-geist-pixel-square)]"
            ...
            <motion.button
              ...
              className="text-xs sm:text-sm font-[family-name:var(--font-geist-mono)] cursor-pointer"
