...
export default function HomeContent() {
  return (
    <main className="flex flex-1 w-full max-w-7xl flex-col items-center justify-center py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 text-zinc-100 sm:flex-row sm:items-center sm:justify-between gap-6 sm:gap-8 md:gap-12">
      ...
      >
        <motion.h1
          className="max-w-xs sm:max-w-sm md:max-w-md text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold leading-8 sm:leading-9 md:leading-[1.2] tracking-tight text-white font-[family-name:var(--font-chakra-petch)]"
        ...
        <motion.p
          className="max-w-xs sm:max-w-sm md:max-w-md text-base sm:text-lg md:text-xl leading-7 sm:leading-8 md:leading-9 text-zinc-200 font-[family-name:var(--font-chakra-petch)]"
        ...
        <motion.p
          className="max-w-xs sm:max-w-sm md:max-w-md text-sm sm:text-base md:text-lg lg:text-xl leading-6 sm:leading-7 md:leading-8 text-zinc-400"
          variants={fadeUpVariants}
        >
